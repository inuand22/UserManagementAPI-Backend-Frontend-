...
namespace LogicaDatos.Repositorios
{
    public class RepositorioEventosBD : IRepositorioEvento
    {
        ...
        public IEnumerable<Evento> FindXDescripcion(string name)
        {
            return Contexto.Eventos
                .Include(eve => eve.User)
               .Where(eve => eve.Descripcion.Contains(name))
               .ToList();
        }
        ...
        public IEnumerable<Evento> FindXTipoTramite(ETipoTramite enumTipoTramite)
        {
            return Contexto.Eventos
                .Include(eve => eve.User)
               .Where(eve => eve.EnumTipoTramite == enumTipoTramite)
               .ToList();
        }
    }
}
