...
namespace Api.Controllers
{
    ...
    public class UsuarioController : ControllerBase
    {
        ...
        public IActionResult Get(int id)
        {
            ...
            try
            {
                ListadoUsuariosDTO dto = CUFindUserXId.DTOUsuario(id);
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public IActionResult Post([FromBody] AltaUsuarioDTO? dto)
        {
            if (dto.Id != 0)
            {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public IActionResult Put(int? id, [FromBody] AltaUsuarioDTO? dto)
        {
            if (dto == null)
            {
                return BadRequest("Debe proporcionar un Usuario");
